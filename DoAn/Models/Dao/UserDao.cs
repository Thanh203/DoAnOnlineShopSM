...
namespace DoAn.Models.Dao
{
    public class UserDao
    {
        ...
        public IEnumerable<Product> ListAllPagingProduct(string searchString, int page = 1, int pageSize = 10)
        {
        ...
        public IEnumerable<Product> ListAllPagingCustomer(string searchString, int page = 1, int pageSize = 8)
        {
            IQueryable<Product> model = db.Products;
            if (!string.IsNullOrEmpty(searchString))
            {
